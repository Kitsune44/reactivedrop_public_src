...
void CRD_HoIAF_System::RebuildNotificationList()
{
	...
	if ( rd_notification_debug_fake.GetBool() )
	{
		...
		m_Notifications[2]->BountyMissions[0].Points = 600;
		...
		m_Notifications[2]->BountyMissions[1].Points = 277;
		...
		m_Notifications[2]->BountyMissions[2].Points = 427;
		...
		m_Notifications[2]->BountyMissions[3].Points = 187;
		...
		m_Notifications[2]->BountyMissions[4].Points = 277;
		...
		m_Notifications[3]->BountyMissions[0].Points = 352;
		...
		m_Notifications[3]->BountyMissions[1].Points = 352;
		...
		m_Notifications[3]->BountyMissions[2].Points = 352;
		...
		m_Notifications[3]->BountyMissions[3].Points = 352;
		...
		m_Notifications[3]->BountyMissions[4].Points = 600;
		...
		m_Notifications[4]->BountyMissions[0].Points = 427;
		...
		m_Notifications[4]->BountyMissions[1].Points = 277;
		...
		m_Notifications[4]->BountyMissions[2].Points = 487;
